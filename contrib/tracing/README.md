...
`mempool:added`, `mempool:removed`, and `mempool:rejected` tracepoints.
...
```console
$ python3 contrib/tracing/mempool_monitor.py ./src/dashd
```
...
```
 ...
 │ 13:10:31Z removed d1eecf9d662121322f4f31f0c2267a752d14bb3956e6016ba96e87f47890e1db with feerate 27.12 sat/vB (7213 sat, 266 vbytes): expiry                                  │
