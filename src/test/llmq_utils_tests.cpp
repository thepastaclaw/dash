...
static CSigShare MakeSigShare(uint32_t nonce)
{
    CSigShare sig_share{Consensus::LLMQType::LLMQ_50_60, GetTestQuorumHash(1), GetTestQuorumHash(2),
                        GetTestQuorumHash(nonce), 1, CBLSLazySignature{}};
    sig_share.UpdateKey();
    return sig_share;
}
