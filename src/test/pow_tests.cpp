...
BOOST_AUTO_TEST_CASE(get_next_work)
{
    ...
    const auto chainParamsDev = CreateChainParams(*m_node.args, ChainType::DEVNET);
...
BOOST_AUTO_TEST_CASE(ChainParams_DEVNET_sanity)
{
    ...
    sanity_check_chainparams(*m_node.args, ChainType::DEVNET);
