...
public:
    ...
    //! True if the wallet tracks any watch-only scripts (legacy watch-only set,
    //! or public-only descriptors in a private-key-enabled descriptor wallet).
    bool HaveWatchOnly() const EXCLUSIVE_LOCKS_REQUIRED(cs_wallet);
