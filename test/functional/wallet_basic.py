...
class WalletTest(BitcoinTestFramework):
    ...
    def test_chain_listunspent(self):
        if not self.options.descriptors:
            return
        # Restart node0 with default args: an earlier part of this test left it
        # running with a reduced -limitancestorcount, which is lower than
        # DEFAULT_ANCESTOR_LIMIT used below.
        self.restart_node(0)
