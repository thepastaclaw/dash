...
class RawTransactionsTest(BitcoinTestFramework):
    ...
    def test_locked_wallet(self):
        ...
        # Deduce fee to produce a changeless transaction (the deduced amount must
        # stay below Dash's minimum viable change, which is based on the discard
        # rate and the size of a p2pkh change output)
