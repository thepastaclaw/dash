...
class RawTransactionsTest(BitcoinTestFramework):
    ...
    def test_locked_wallet(self):
        ...
        # Note: unlike in Bitcoin, inputs/outputs are non-segwit here, so the
        # leftover has to stay below Dash's minimum viable change amount
        # (dust at the discard feerate, i.e. 1820 duffs for a P2PKH output).
